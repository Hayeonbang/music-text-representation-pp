...
from mtrpp.transfer.dataset_wavs.annotation import Annotation_Dataset
# from mtrpp.transfer.dataset_wavs.youtube import Youtube_Dataset
...
def get_dataset(
    ...
    if eval_dataset == "annotation":
        ...
        dataset = Youtube_Dataset(data_path, split, sr, duration, num_chunks)
